...
public class Doc extends JFrame {
   ...
   private void initComponents() {
       ...
       JLabel lblNewLabel_2 = new JLabel("Cãutare persoane");
       ...
       btnNewButton_1 = new JButton("Cãutare");
       ...
       btnNewButton.setFont(new Font("Myriad Pro Light", Font.PLAIN, 17));
       ...
       btnNewButton2.setFont(new Font("Myriad Pro Light", Font.BOLD, 17));
   ...
   private void btnNewButton_1MouseClicked(java.awt.event.MouseEvent evt) {
   	try {
   		...
   		String nr_act = textField.getText();
   		String serie = textField_1.getText();
